...
class Nifti2DcmConverter:
    ...
    def convert_series(self, case_path, patient_id, series_tag_values, seed='42', segmentation=None, seg_args=None, seg_info_path=None, *args, **kwds):
        """
        ...
        series_instance_UID = kwds.get("series_uid") or generate_uid(entropy_srcs=[series_tag_values['0020|000d'], series_id, seed])
