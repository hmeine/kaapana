...
mc admin config set kaapana notify_webhook:dicomsupload queue_limit="0"  endpoint="http://airflow-service.$SERVICES_NAMESPACE.svc:8080/flow/kaapana/api/trigger/service-minio-dicom-upload" queue_dir=""
mc admin config set kaapana notify_webhook:itkupload queue_limit="0"  endpoint="http://airflow-service.$SERVICES_NAMESPACE.svc:8080/flow/kaapana/api/trigger/dag-convert-nifti-2-dcm" queue_dir=""
